...
class UserVerifyPhoneOTPPage extends StatefulWidget {
  const UserVerifyPhoneOTPPage(
      {Key? key,
      required this.token,
  ...
  @override
  State<UserVerifyPhoneOTPPage> createState() => _UserVerifyPhoneOTPPageState();
}

class _UserVerifyPhoneOTPPageState extends State<UserVerifyPhoneOTPPage> {
                ...
                child: PinCodeTextField(
                  ...
                  onCompleted: (v) async {
                    if (await _validateOTP()) {
                      ...
                      //   context,
                      //   MaterialPageRoute(
                      //     builder: (_) => const UserVerifyEmailSkipPage(),
                      //   ),
                      // );
                    } else {
  ...
  _save() async {
    try {
      ...
      final response =
          await Dio().post('$serverUrl/dcc-api/m/Register/update', data: user);
