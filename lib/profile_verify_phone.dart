import 'package:des_mobile_admin_v3/profile_verify_phone_otp.dart';
...
class ProfileVerifyPhonePage extends StatefulWidget {
  const ProfileVerifyPhonePage({Key? key}) : super(key: key);

  @override
  State<ProfileVerifyPhonePage> createState() => _ProfileVerifyPhonePageState();
}

class _ProfileVerifyPhonePageState extends State<ProfileVerifyPhonePage> {
  ...
  _requestOTP() async {
    ...
    if (otp['token'] != null) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (_) => ProfileVerifyPhoneOTPPage(
            token: otp['token'],
