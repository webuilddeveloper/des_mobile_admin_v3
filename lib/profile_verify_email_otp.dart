...
class ProfileVerifyEmailOTPPage extends StatefulWidget {
  const ProfileVerifyEmailOTPPage({Key? key, required this.email})
      : super(key: key);

  final String email;

  @override
  State<ProfileVerifyEmailOTPPage> createState() =>
      _ProfileVerifyEmailOTPPageState();
}

class _ProfileVerifyEmailOTPPageState extends State<ProfileVerifyEmailOTPPage> {
