...
class UserVerifyEmailPage extends StatefulWidget {
  const UserVerifyEmailPage({Key? key}) : super(key: key);

  @override
  State<UserVerifyEmailPage> createState() => _UserVerifyEmailPageState();
}

class _UserVerifyEmailPageState extends State<UserVerifyEmailPage> {
    ...
    try {
      ...
      if (result['status'] == "S") {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => UserVerifyEmailOTPPage(
              // model: widget.model,
